...
namespace R54_M9_Evidence_08_Mid.Models
{
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            for (int i = 1; i <= 8; i++)
            {
                modelBuilder.Entity<Sale>().HasData(
                   new Sale { SaleId = i, Date = DateTime.Now.AddDays(-1 * random.Next(200, 500)), Quantity = random.Next(100, 300), DressId = i % 5 == 0 ? 5 : i % 5 }
